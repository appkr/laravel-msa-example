package dev.appkr.hello.web.rest.errors;

import dev.appkr.hello.HelloApp;
import dev.appkr.hello.config.SecurityBeanOverrideConfiguration;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, HelloApp.class})
